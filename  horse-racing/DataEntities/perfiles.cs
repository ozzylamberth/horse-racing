...
namespace DataEntities
{
    ...
    public partial class perfiles: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void Fixupmenu(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    if (!item.perfiles.Contains(this))
                    {
                        item.perfiles.Add(this);
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
